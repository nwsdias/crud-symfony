...
class ClienteController extends AbstractController
{
    ...
    /**
     * @Route("/{cpf}", name="cliente_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{cpf}/edit", name="cliente_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{cpf}", name="cliente_delete", methods={"POST"})
     */
    public function delete(Request $request, Cliente $cliente): Response
    {
        if ($this->isCsrfTokenValid('delete'.$cliente->getCpf(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
